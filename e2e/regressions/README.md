...
This folder currently has no regression specs because this regimen is just
starting, not because the folder is omitted or incomplete. New regression
specs should use the existing helpers and follow the coverage and determinism
requirements in [`../../docs/E2E_TEST_PLAN.md`](../../docs/E2E_TEST_PLAN.md).
